module "azure_databricks_module" {
  ...
  is_dev                     = module.resource_group_module.is_dev
  vnet_name                  = module.resource_group_module.vnet_name
  vnet_rg                    = module.resource_group_module.vnet_rg
  dbr_subnet_public          = module.resource_group_module.subnet_name_dbrpub
  dbr_subnet_private         = module.resource_group_module.subnet_name_dbrprv
  subnet_id_pep              = module.resource_group_module.subnet_id_pep
