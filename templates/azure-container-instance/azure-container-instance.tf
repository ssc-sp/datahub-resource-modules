module "azure_container_instance_module" {
  source     = "github.com/ssc-sp/datahub-resource-modules//modules/azure-container-instance{{tag}}"
...
output "azure_container_instance_status" {
  value = "completed"
}
