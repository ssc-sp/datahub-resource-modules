module "azure_postgresql_module" {
  source = "github.com/ssc-sp/datahub-resource-modules//modules/azure-postgresql-enhanced{{tag}}"
  ...
  psql_version               = "12"
  subnet_id_psql             = module.resource_group_module.subnet_id_psql
  psql_dns_zone_id           = var.psql_dns_zone_id
