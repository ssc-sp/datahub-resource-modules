...
locals {
  ...
  project_tags              = merge(var.common_tags, { "project_cd" : var.project_cd, "SSC_CBRID" : "${var.ssc_cbrid}_FSDH", "created_date" : formatdate("YYYY-MM-DD", time_static.proj_first_created.rfc3339) })
